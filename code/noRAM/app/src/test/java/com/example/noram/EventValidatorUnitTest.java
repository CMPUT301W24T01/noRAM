...
public class EventValidatorUnitTest {
    ...
    private static Stream<Arguments> objectProvideParameter() {
        return Stream.of(
                Arguments.of(new Event("id", "My Event", "My House", LocalDateTime.now(), LocalDateTime.now(), "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), true),
                Arguments.of(new Event("id", "", "My House", LocalDateTime.now(), LocalDateTime.now(), "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), false),
                Arguments.of(new Event("id", "My Event", "", LocalDateTime.now(), LocalDateTime.now(), "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), false),
                Arguments.of(new Event("id", "My Event", "My House", null, LocalDateTime.now(), "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), false),
                Arguments.of(new Event("id", "My Event", "My House", LocalDateTime.now(), null, "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), false),
                Arguments.of(new Event("id", "My Event", "My House", LocalDateTime.now(), LocalDateTime.now(), "cool details", null, null, null, false, new ArrayList<>(), "organizerId"), false),
                Arguments.of(new Event("id", "My Event", "My House", LocalDateTime.now(), LocalDateTime.of(2002, 2, 2, 2, 2), "cool details", new ArrayList<>(), null, null, false, new ArrayList<>(), "organizerId"), false)
        );
    }
